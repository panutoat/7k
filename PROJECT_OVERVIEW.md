...
>
> อัปเดตล่าสุด: 2026-06-21 · branch `main` · commit `cb8f424`
...
| Hosting | ออกแบบให้ deploy ฟรีได้ (Vercel + Neon/Supabase) — รูปเก็บเป็น **ลิงก์** ไม่ใช่ bytes เพื่อให้ DB เล็ก |
...
| `defense_library` | คลังกลาง (central library) ของ defense template ใช้ซ้ำข้ามสงครามได้ |
...
- **ล่าสุด (`cb8f424`)**: ทีมโจมตีแนะนำต่อ defense (admin) + โชว์ก่อนเมื่อเลือกเป้าหมาย
